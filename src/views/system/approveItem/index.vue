<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column prop="userId" label="审批用户ID"/>
      <el-table-column prop="validEndTime" label="有效期结束时间">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.validEndTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column prop="nextExuserId" label="下一步审批用户ID"/>
...
import { del } from '@/api/approveItem'
